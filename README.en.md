>[!WARNING]
>**This version of the website is now archived meaning it will NOT get updates from now on.** Instead, the work will be directed towards updating and maintaining [version 3](https://www.github.com/AbdullahMRiad/clean-tansik-v3)
...
3. From here, you can:
  ...
  - ~~Deploy it to Vercel by running `npm i -g vercel` then `vercel` (free with sign up required)~~ (vercel is run by a zionist CEO)
